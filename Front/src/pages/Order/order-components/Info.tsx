    ...
    <section className={styles.infoWrapper}>
      ...
      <div className={styles.textsWrapper}>
        <p className={styles.text}>
          ...
          поэтому срок от приёма заказа до его отправки такого заказа составляет{" "}
          <span>3-5 рабочих дня</span> после 100% оплаты.
        </p>
        <p className={styles.text}>
          После обработки заказа нашими операторами, информация о заказе будет
          отправлена на e-mail, указанный при оформлении заказа
        </p>
      </div>
    </section>
  );
